	...
	internal static class DefGen
	{
		...
		internal static ThingDef BaseDef(ThingDef baseDef, bool isDowngrade = false)
		{
			return new ThingDef
			{
				...
				stuffCategories = isDowngrade ? null : baseDef.stuffCategories,
				costList = isDowngrade ? null : baseDef.costList,
				costStuffCount = isDowngrade ? 0 : baseDef.costStuffCount,
				stuffProps = isDowngrade ? null : baseDef.stuffProps,
